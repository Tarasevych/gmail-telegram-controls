...
$RollbackVersion = 57
$LegacyStagingVersion = 59
$CandidateVersion = 60
$ReleaseDescription = 'Telegram Gmail Versie 1 (2026-07-22): P0 cached navigation and draft recovery'
$StagingDescription = 'Telegram Gmail Versie 1 (2026-07-22) P0 cached navigation and draft recovery'
$LegacyStagingDescription = 'Telegram Gmail Versie 1 (2026-07-22) recover stale Mini App thread routes'
$ProjectRoot = Split-Path -Parent $PSScriptRoot
$SourceMainSha = '4440cc938c29dad12d7b1e8575fec17994acbd8f'
$JournalPath = Join-Path $HOME '.codex\recovery\019f7620-bb25-7bd0-a9ea-9034d55103ac-versie-001-20260722-v60-release.json'
...
$mutex = [Threading.Mutex]::new($false, 'Local\TarasevychGmailNotifierVersie00120260722V60Release')
