...
$RollbackVersion = 64
$LegacyStagingVersion = 64
$CandidateVersion = 65
$ReleaseDescription = 'Telegram Gmail Versie 1 (2026-07-23): align production client release discovery'
$StagingDescription = 'Telegram Gmail Versie 1 (2026-07-23) align production client release discovery'
$LegacyStagingDescription = 'Telegram Gmail Versie 1 (2026-07-22) expose full active Gmail address'
$ProjectRoot = Split-Path -Parent $PSScriptRoot
$SourceMainSha = '3373ca4aa403a28f3252ad72fbe65310b318c53c'
$JournalPath = Join-Path $HOME '.codex\recovery\019f7620-bb25-7bd0-a9ea-9034d55103ac-versie-001-20260723-v65-release.json'
...
$mutex = [Threading.Mutex]::new($false, 'Local\TarasevychGmailNotifierVersie00120260723V65Release')
