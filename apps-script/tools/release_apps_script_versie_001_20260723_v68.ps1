...
$RollbackVersion = 65
$LegacyStagingVersion = 67
$CandidateVersion = 68
$ReleaseDescription = 'Telegram Gmail Versie 1 (2026-07-23): V3 cache-first owner-bound launch'
$StagingDescription = 'Telegram Gmail Versie 1 (2026-07-23) V3 cache-first owner-bound launch'
$LegacyStagingDescription = 'Telegram Gmail Versie 1 (2026-07-23) P0 one-second single-flight launch'
$ProjectRoot = Split-Path -Parent $PSScriptRoot
$SourceMainSha = '3f6b23b6ff1cf9d0e2b2eb512ba3416f201eb6d3'
$JournalPath = Join-Path $HOME '.codex\recovery\019f7620-bb25-7bd0-a9ea-9034d55103ac-versie-001-20260723-v68-release.json'
...
$mutex = [Threading.Mutex]::new($false, 'Local\TarasevychGmailNotifierVersie00120260723V68Release')
