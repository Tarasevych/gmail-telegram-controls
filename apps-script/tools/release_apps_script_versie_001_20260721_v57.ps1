...
$CandidateVersion = 57
$ReleaseDescription = 'Telegram Gmail Versie 1 (2026-07-21): preserve connection-scoped Gmail metadata identity'
$StagingDescription = 'Telegram Gmail Versie 1 (2026-07-21) preserve connection-scoped Gmail metadata identity'
$LegacyStagingDescription = 'Telegram Gmail Versie 1 (2026-07-21) isolate timer overlap and URLFetch quota'
$ProjectRoot = Split-Path -Parent $PSScriptRoot
$JournalPath = Join-Path $HOME '.codex\recovery\019f5d65-8209-7a00-b915-4a522dbcb612-versie-001-20260721-v57-release.json'
...
$mutex = [Threading.Mutex]::new($false, 'Local\TarasevychGmailNotifierVersie00120260721V57Release')
