...
$RollbackVersion = 57
$LegacyStagingVersion = 61
$CandidateVersion = 62
$ReleaseDescription = 'Telegram Gmail Versie 1 (2026-07-22): P0 exact account-scoped list isolation'
$StagingDescription = 'Telegram Gmail Versie 1 (2026-07-22) P0 exact account-scoped list isolation'
$LegacyStagingDescription = 'Telegram Gmail Versie 1 (2026-07-22) P0 account-isolated cached navigation'
$ProjectRoot = Split-Path -Parent $PSScriptRoot
$SourceMainSha = '142ef94e29def8f1fa03d74271594c72c2db1e92'
$JournalPath = Join-Path $HOME '.codex\recovery\019f7620-bb25-7bd0-a9ea-9034d55103ac-versie-001-20260722-v62-release.json'
...
$mutex = [Threading.Mutex]::new($false, 'Local\TarasevychGmailNotifierVersie00120260722V62Release')
