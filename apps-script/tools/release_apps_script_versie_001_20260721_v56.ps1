...
$CandidateVersion = 56
$ReleaseDescription = 'Telegram Gmail Versie 1 (2026-07-21): isolate timer overlap and URLFetch quota'
$StagingDescription = 'Telegram Gmail Versie 1 (2026-07-21) isolate timer overlap and URLFetch quota'
$LegacyStagingDescription = 'Telegram Gmail Versie 1 (2026-07-20) staging-only exact Spam trace maintenance'
$ProjectRoot = Split-Path -Parent $PSScriptRoot
$JournalPath = Join-Path $HOME '.codex\recovery\019f5d65-8209-7a00-b915-4a522dbcb612-versie-001-20260721-v56-release.json'
...
$mutex = [Threading.Mutex]::new($false, 'Local\TarasevychGmailNotifierVersie00120260721V56Release')
...
try {
  ...
  Invoke-GoogleJson PUT $stableUri @{deploymentConfig=@{scriptId=$ScriptId;versionNumber=$RollbackVersion;
    manifestFileName='appsscript';description='Rollback to verified Telegram Gmail Versie 1 Apps Script v55'}} | Out-Null
