...
$RollbackVersion = 42
$LegacyStagingVersion = 47
$CandidateVersion = 48
$ReleaseDescription = 'Telegram Gmail Versie 1 (2026-07-20): independent realtime lane lease'
$StagingDescription = 'Telegram Gmail Versie 1 (2026-07-20) independent realtime lane lease staging'
$LegacyStagingDescription = 'Telegram Gmail Versie 1 (2026-07-20) mail-card index compaction staging'
$ProjectRoot = Split-Path -Parent $PSScriptRoot
$JournalPath = Join-Path $HOME '.codex\recovery\019f5d65-8209-7a00-b915-4a522dbcb612-versie-001-20260720-v48-release.json'
...
$mutex = [Threading.Mutex]::new($false, 'Local\TarasevychGmailNotifierVersie00120260720V48Release')
...
try {
  ...
  if ($StageOnly) {
    ...
    # Keep the exact v43 staging until its v44 replacement is verified.
    try {
      if (-not $immutable) {
