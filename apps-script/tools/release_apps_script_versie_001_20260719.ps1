...
$RollbackVersion = 42
$LegacyStagingVersion = 44
$CandidateVersion = 45
$ReleaseDescription = 'Telegram Gmail Versie 1 (2026-07-20): runtime-isolated realtime delivery'
$StagingDescription = 'Telegram Gmail Versie 1 (2026-07-20) runtime-isolated realtime delivery staging'
$LegacyStagingDescription = 'Telegram Gmail Versie 1 (2026-07-20) realtime legacy-context repair staging'
$ProjectRoot = Split-Path -Parent $PSScriptRoot
$JournalPath = Join-Path $HOME '.codex\recovery\019f5d65-8209-7a00-b915-4a522dbcb612-versie-001-20260720-v45-release.json'
...
$mutex = [Threading.Mutex]::new($false, 'Local\TarasevychGmailNotifierVersie00120260720V45Release')
