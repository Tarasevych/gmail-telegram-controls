...
$RollbackVersion = 50
$LegacyStagingVersion = 53
$CandidateVersion = 54
$ReleaseDescription = 'Telegram Gmail Versie 1 (2026-07-20): staging-only exact Spam trace maintenance'
$StagingDescription = 'Telegram Gmail Versie 1 (2026-07-20) staging-only exact Spam trace maintenance'
$LegacyStagingDescription = 'Telegram Gmail Versie 1 (2026-07-20) protected per-account Gmail trace staging'
$ProjectRoot = Split-Path -Parent $PSScriptRoot
$JournalPath = Join-Path $HOME '.codex\recovery\019f5d65-8209-7a00-b915-4a522dbcb612-versie-001-20260720-v54-release.json'
...
$mutex = [Threading.Mutex]::new($false, 'Local\TarasevychGmailNotifierVersie00120260720V54Release')
