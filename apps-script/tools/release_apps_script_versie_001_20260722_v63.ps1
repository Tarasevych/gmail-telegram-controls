...
$RollbackVersion = 57
$LegacyStagingVersion = 62
$CandidateVersion = 63
$ReleaseDescription = 'Telegram Gmail Versie 1 (2026-07-22): prevent minute worker overlap'
$StagingDescription = 'Telegram Gmail Versie 1 (2026-07-22) prevent minute worker overlap'
$LegacyStagingDescription = 'Telegram Gmail Versie 1 (2026-07-22) P0 exact account-scoped list isolation'
$ProjectRoot = Split-Path -Parent $PSScriptRoot
$SourceMainSha = 'cd4c32c5af2a61161c0fc6e1b25cffa04e22f724'
$JournalPath = Join-Path $HOME '.codex\recovery\019f7620-bb25-7bd0-a9ea-9034d55103ac-versie-001-20260722-v63-release.json'
...
$mutex = [Threading.Mutex]::new($false, 'Local\TarasevychGmailNotifierVersie00120260722V63Release')
