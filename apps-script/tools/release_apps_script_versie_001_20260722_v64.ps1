...
$RollbackVersion = 63
$LegacyStagingVersion = 63
$CandidateVersion = 64
$ReleaseDescription = 'Telegram Gmail Versie 1 (2026-07-22): expose full active Gmail address'
$StagingDescription = 'Telegram Gmail Versie 1 (2026-07-22) expose full active Gmail address'
$LegacyStagingDescription = 'Telegram Gmail Versie 1 (2026-07-22) prevent minute worker overlap'
$ProjectRoot = Split-Path -Parent $PSScriptRoot
$SourceMainSha = 'da8b2768323db8fd8c1ba886b556bbfd2148d6de'
$JournalPath = Join-Path $HOME '.codex\recovery\019f7620-bb25-7bd0-a9ea-9034d55103ac-versie-001-20260722-v64-release.json'
...
$mutex = [Threading.Mutex]::new($false, 'Local\TarasevychGmailNotifierVersie00120260722V64Release')
