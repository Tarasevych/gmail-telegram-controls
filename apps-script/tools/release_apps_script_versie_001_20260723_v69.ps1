...
$RollbackVersion = 65
$LegacyStagingVersion = 68
$CandidateVersion = 69
$ReleaseDescription = 'Telegram Gmail Versie 1 (2026-07-23): V3 persistent app session recovery'
$StagingDescription = 'Telegram Gmail Versie 1 (2026-07-23) V3 persistent app session recovery'
$LegacyStagingDescription = 'Telegram Gmail Versie 1 (2026-07-23) V3 cache-first owner-bound launch'
$ProjectRoot = Split-Path -Parent $PSScriptRoot
$SourceMainSha = '33cc55fab95659f11ec90ad046106fdeff8bf03b'
$JournalPath = Join-Path $HOME '.codex\recovery\019f7620-bb25-7bd0-a9ea-9034d55103ac-versie-001-20260723-v69-release.json'
...
$mutex = [Threading.Mutex]::new($false, 'Local\TarasevychGmailNotifierVersie00120260723V69Release')
