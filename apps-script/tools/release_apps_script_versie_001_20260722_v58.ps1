...
$RollbackVersion = 57
$LegacyStagingVersion = 56
$CandidateVersion = 58
$ReleaseDescription = 'Telegram Gmail Versie 1 (2026-07-22): cumulative label manager and owner Gmail adapter'
$StagingDescription = 'Telegram Gmail Versie 1 (2026-07-22) cumulative label manager and owner Gmail adapter'
$LegacyStagingDescription = 'Telegram Gmail Versie 1 (2026-07-21) isolate timer overlap and URLFetch quota'
$ProjectRoot = Split-Path -Parent $PSScriptRoot
$JournalPath = Join-Path $HOME '.codex\recovery\019f7620-bb25-7bd0-a9ea-9034d55103ac-versie-001-20260722-v58-release.json'
...
$ExpectedRollbackHashes = $ExpectedCandidateHashes.Clone()
$ExpectedRollbackHeadDriftHashes = $ExpectedCandidateHashes.Clone()
$ExpectedCandidateHashes = @{
...
$mutex = [Threading.Mutex]::new($false, 'Local\TarasevychGmailNotifierVersie00120260722V58Release')
