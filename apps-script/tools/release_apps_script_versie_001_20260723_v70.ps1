...
$RollbackVersion = 65
$LegacyStagingVersion = 69
$CandidateVersion = 70
$ReleaseDescription = 'Telegram Gmail Versie 1 (2026-07-23): P0 ONE-SECOND session diagnostics'
$StagingDescription = 'Telegram Gmail Versie 1 (2026-07-23) P0 ONE-SECOND session diagnostics'
$LegacyStagingDescription = 'Telegram Gmail Versie 1 (2026-07-23) V3 persistent app session recovery'
$ProjectRoot = Split-Path -Parent $PSScriptRoot
$SourceMainSha = '0666165b614f430103530728aa45349083db5e78'
$JournalPath = Join-Path $HOME '.codex\recovery\019f7620-bb25-7bd0-a9ea-9034d55103ac-versie-001-20260723-v70-release.json'
...
$mutex = [Threading.Mutex]::new($false, 'Local\TarasevychGmailNotifierVersie00120260723V70Release')
