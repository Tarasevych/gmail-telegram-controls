...
$RollbackVersion = 65
$LegacyStagingVersion = 66
$CandidateVersion = 67
$ReleaseDescription = 'Telegram Gmail Versie 1 (2026-07-23): P0 one-second single-flight launch'
$StagingDescription = 'Telegram Gmail Versie 1 (2026-07-23) P0 one-second single-flight launch'
$LegacyStagingDescription = 'Telegram Gmail Versie 1 (2026-07-23) restore SENT+INBOX exactly-once delivery'
$ProjectRoot = Split-Path -Parent $PSScriptRoot
$SourceMainSha = '308fd6081ed6bbb56ae2dd6e423c1db17bb9e4d2'
$JournalPath = Join-Path $HOME '.codex\recovery\019f7620-bb25-7bd0-a9ea-9034d55103ac-versie-001-20260723-v67-release.json'
...
$mutex = [Threading.Mutex]::new($false, 'Local\TarasevychGmailNotifierVersie00120260723V67Release')
