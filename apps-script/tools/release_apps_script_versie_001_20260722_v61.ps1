...
$RollbackVersion = 57
$LegacyStagingVersion = 60
$CandidateVersion = 61
$ReleaseDescription = 'Telegram Gmail Versie 1 (2026-07-22): P0 account-isolated cached navigation'
$StagingDescription = 'Telegram Gmail Versie 1 (2026-07-22) P0 account-isolated cached navigation'
$LegacyStagingDescription = 'Telegram Gmail Versie 1 (2026-07-22) P0 cached navigation and draft recovery'
$ProjectRoot = Split-Path -Parent $PSScriptRoot
$SourceMainSha = '14fe3ddc66500f98d57e32d0a3c2fab99813cd8e'
$JournalPath = Join-Path $HOME '.codex\recovery\019f7620-bb25-7bd0-a9ea-9034d55103ac-versie-001-20260722-v61-release.json'
...
$mutex = [Threading.Mutex]::new($false, 'Local\TarasevychGmailNotifierVersie00120260722V61Release')
