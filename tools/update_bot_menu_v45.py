#!/usr/bin/env python3
"""Atomically switch the exact owner bot menu between v45 staging and production."""
...
STAGING_URL = "https://tarasevych.github.io/gmail-telegram-controls/v45-staging-acceptance-20260718.html"
...
def main() -> int:
    ...
    target = {
        "type": "web_app",
        "text": "🧪 Пошта v45" if args.mode == "staging" else "📬 Пошта",
