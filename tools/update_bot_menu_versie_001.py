...
STAGING_URL = "https://tarasevych.github.io/gmail-telegram-controls/versie-001-staging-acceptance-20260723-v69.html"
...
def main() -> int:
    ...
    target = {
        "type": "web_app",
        "text": "🧪 Пошта · Versie 1 v69" if args.mode == "staging" else "📬 Пошта · Versie 1",
