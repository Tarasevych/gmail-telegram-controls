...
STAGING_URL = "https://tarasevych.github.io/gmail-telegram-controls/versie-001-staging-acceptance-20260723-v70.html"
...
def main() -> int:
    ...
    target = {
        "type": "web_app",
        "text": "🧪 Пошта · Versie 1 v70" if args.mode == "staging" else "📬 Пошта · Versie 1",
