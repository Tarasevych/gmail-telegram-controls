...
- Перед використанням report-derived твердження відкрити актуальний verification-report index активної Versie та claim-level evidence; repository evidence не є runtime або production acceptance.
...
- Before relying on a report-derived claim, open the active Versie's current verification-report index and claim-level evidence; repository evidence is not runtime or production acceptance.
