...
| Page | Purpose |
|---|---|
| [SOURCE_MANIFEST.md](SOURCE_MANIFEST.md) | Sources, hashes, sizes, and counts |
| [TRACEABILITY.md](TRACEABILITY.md) | One canonical route for every source ID |
| [MASTER_ROADMAP.md](MASTER_ROADMAP.md) | Phases, dependencies, status, and gates |
| [INSTRUCTIONS.md](INSTRUCTIONS.md) | Standing-rule candidates; not authority |
| [PERMISSIONS.md](PERMISSIONS.md) | Permission/privacy reference; not grants |
