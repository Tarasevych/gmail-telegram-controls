...
Extraction hashes were calculated from recovery buffers; original-source metadata is report-derived only.
...
R1 reports evidence=11 and lesson=5, while its atomic rows yield evidence=12 and lesson=4. Total=74 matches; no entry was invented or reclassified.
