...
Оновлено: **2026-07-21**. Статуси: `Відкрита`, `В роботі`, `Заблокована`, `Вирішена локально`, `Перевірена production`.

| ID | Статус | З Versie | Проблема | Рішення / наступний доказ |
|---|---|---:|---|---|
| GT-001 | Вирішена локально | 1 | Один лист надходить у Telegram двічі | v55 виключає Sent-копію, навіть коли Gmail також додає Inbox; 432/432 tests і PreflightOnly пройшли; ще потрібні staging та live acceptance однієї картки |
