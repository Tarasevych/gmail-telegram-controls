...
| RCA-008 | Telegram callback міг віддати інше вкладення | Callback використовував mutable MIME ordinal, а не exact Gmail attachment identity | Opaque exact token, single-match lookup і fail-closed ambiguity merged; native download ще не перевірено | Стабільна identity, reorder/duplicate-name tests і жодного raw attachment ID у callback | PARTIAL | [VR-018](verification-reports/reports/VR-018/README.md) |
