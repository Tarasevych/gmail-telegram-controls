...
- **Ще потрібно:** merge/CI source v70; один immutable staging; десять native запусків; точний SecureStorage status; hard reload; cached thread; mobile/WebView reopen; concurrent launch; вимірюваний p95.
...
- **Release boundary:** production v65 і staging `0` незмінні; immutable v69 залишається історичним; v70 поки лише локальний cumulative source candidate.
