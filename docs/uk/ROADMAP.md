...
- **Статус:** PARTIAL — root cause VERIFIED; source candidate підготовлено; live release UNVERIFIED.
...
- **Межа:** production exact v57, immutable v58 і один staging не змінені; promotion, cleanup та v59 не дозволені.
