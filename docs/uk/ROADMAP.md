...
- **Ще потрібно:** інтеграція thread detail, draft persistence і URL import; resumable server session та restart recovery; native slow/stalled network, minimize, cancel, retry і provider readback.
