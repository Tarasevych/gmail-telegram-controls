...
- **Статус:** PARTIAL — інтегровано в immutable v58, protected flag не ввімкнено, live evidence заблокований GT-028.
...
- **Статус:** BLOCKED.
- **Виконано:** PR #16 і PR #11 merged normal; cumulative immutable v58 створено; один staging збережено; local full suite `460/460`; main checks green.
- **A/B:** v58 staging і v57 production відтворюють однакову mailbox-operation error, а test windows не створюють Web App executions.
- **Межа:** production лишається v57; menu production; promotion, cleanup і новий immutable не виконуються.
- **Наступний доказ:** повторити fail-closed A/B лише після відновлення transport/deployment access; якщо v57 pass, а v58 fail — діагностувати candidate; якщо обидва fail — не перемикати релізи.
