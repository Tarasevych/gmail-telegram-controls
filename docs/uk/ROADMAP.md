...
- **Статус:** PARTIAL — architecture, baseline, source, automated gates, responsive checks і owner-only v62 staging/UI acceptance зафіксовано; runtime execution gate і повний production acceptance заблоковані GT-030.
...
- **Доказ:** [VR-009](verification-reports/reports/VR-009/README.md) і [VR-010](verification-reports/reports/VR-010/README.md).
- **Release boundary:** immutable v62 збережено, staging `0`, production є exact v57 після rollback. Не використовувати v62 повторно й не створювати наступний immutable без causal fix GT-030 та content-free execution evidence.
- **English mirror:** [docs/en/ROADMAP.md](../en/ROADMAP.md).
