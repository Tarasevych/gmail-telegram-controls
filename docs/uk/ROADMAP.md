...
## B1-20 — Єдине доступне керування Gmail-мітками
...
- **Доказ:** [GT-026](ISSUES.md), [VR-005](verification-reports/reports/VR-005/README.md).
- **Залишилось:** BLOCKED до окремого owner authorization на новий immutable candidate; після цього потрібні staging acceptance, контрольований promote/rollback gate і production verification.
